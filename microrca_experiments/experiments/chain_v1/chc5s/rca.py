...
def parse_args():
    ...
    parser.add_argument('--include_db', type=bool, required=False,
                        default=False,
                        help='whether to include anomaly detection for dbs')
...
if __name__ == '__main__':
    ...
    rca = Microrca(node_dict=node_dict, folder_path=folder_path, len_second=len_second, ad_threshold=ad_threshold, alpha=alpha, prom_url=prom_url, k_namespace=namespace, include_db=include_db)
